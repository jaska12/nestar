...
export class BoardArticleService {
    ...
    public async updateBoardArticle(memberId: ObjectId, input: BoardArticleUpdate): Promise<BoardArticle> {
        ...
        if (articleStatus === BoardArticleStatus.DELETE) input.deletedAt = moment().toDate();
    ...
    public async getBoardArticles(memberId: ObjectId, input: BoardArticlesInquiry): Promise<BoardArticles> {
        const { articleCategory, text, memberId: searchMemberId } = input.search;
    ...
    public async removeBoardArticleByAdmin(articleId: ObjectId): Promise<BoardArticle> {
        ...
        const result = (await this.boardArticleModel.findOneAndDelete(search).exec()) as BoardArticle;
